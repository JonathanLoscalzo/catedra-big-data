...
public class Worker extends Configured implements Tool {
	...
	private Job setupJob(Configuration conf, String[] args) throws IOException{		
	    ...
	    MultipleInputs.addInputPath(job, new Path("Conjuntos/"+args[0]), TextInputFormat.class, IntersectionMapper.class);
	    MultipleInputs.addInputPath(job, new Path("Conjuntos/"+args[1]), TextInputFormat.class, IntersectionMapper.class);
