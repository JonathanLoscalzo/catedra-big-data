...
public class Worker extends Configured implements Tool {
	...
	private Job setupJob(Configuration conf) throws IOException{		
	    ...
	    MultipleInputs.addInputPath(job, new Path("Conjuntos/A.txt"), TextInputFormat.class, DiffMapperFromA.class);
	    MultipleInputs.addInputPath(job, new Path("Conjuntos/B.txt"), TextInputFormat.class, DiffMapperFromB.class);
