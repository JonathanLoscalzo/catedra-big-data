...
public class Worker extends Configured implements Tool {
	...
	private Job setupJob(Configuration conf, String[] args) throws IOException{		
		Job job = new Job(conf, "UnionMapper");
	    ...
	    MultipleInputs.addInputPath(job, new Path("Conjuntos/"+args[0]), TextInputFormat.class, UnionMapper.class);
	    MultipleInputs.addInputPath(job, new Path("Conjuntos/"+args[1]), TextInputFormat.class, UnionMapper.class);
