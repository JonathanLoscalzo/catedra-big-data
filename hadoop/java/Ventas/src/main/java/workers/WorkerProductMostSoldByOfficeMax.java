...
import soldProductsByOfficeMax.MaxMapper;
import soldProductsByOfficeMax.MaxReducer;
import writables.*;

public class WorkerProductMostSoldByOfficeMax {
	...
	public static Job setupJob(Configuration conf, String input) throws IOException {
		...
		job.setMapOutputValueClass(ProductoCantidadWritable.class);

		// configure Reducer
		job.setReducerClass(MaxReducer.class);
		// job.setCombinerClass(SoldProductsByOfficeReducer.class);
		job.setOutputKeyClass(Text.class);
		job.setOutputValueClass(ProductoCantidadWritable.class);
